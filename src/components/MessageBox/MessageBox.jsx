        ...
        <Container>
            <Paper variant="outlined">
                <Container>
                    ...
                    {message.user_id === user.id && !message.marked_for_delete &&
                        <Box display="inline-block" align="right" width="20%">
                            <Button variant="outlined" color="warning" onClick={() => { setModalOpen(true); setNewContent(message.content) }}><EditIcon />
                            </Button>
                        </Box>}
                </Container>
